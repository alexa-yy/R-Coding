...
could use any words,numbers,_and so on
3 not valid names:
1 cust name--- shouldnt have space
2 1cust_name ---shouldnt start with numbers
3 客户_name ----shouldnt use chinese (or this kind of special words that computer couldnt recognize)
...
with class it will return to attribut
with str it will structured
explaination are same,?will be faster
